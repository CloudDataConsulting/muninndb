...
| `observe` | Yes | No | **No** — scores are computed but nothing is persisted | Dashboards, analytics, read-only partners, exports |
| `write` | No | Yes | No read-triggered effects | Ingest-only integrations |
